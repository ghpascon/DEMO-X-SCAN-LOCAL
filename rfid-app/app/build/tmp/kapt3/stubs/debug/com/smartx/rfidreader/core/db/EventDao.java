...
public abstract interface EventDao {
    ...
    @androidx.room.Query(value = "SELECT * FROM rfid_events WHERE id = :id LIMIT 1")
    @org.jetbrains.annotations.Nullable()
